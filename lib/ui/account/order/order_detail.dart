...
import 'package:devkitflutter/ui/account/order/order_status.dart';
        ...
        child: Container(
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailPage(name: name, image: image, price: price, rating: 5, review: 23, sale: 40,color:[],size:[])));
                },
                child: Container(

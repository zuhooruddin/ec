    ...
    return Container(
      child: Card(
        ...
        child: GestureDetector(
          ...
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailPage(name: flashsaleData[index].name, image: flashsaleData[index].image, price: flashsaleData[index].price, rating: 4, review: 45, sale: flashsaleData[index].sale,color:[],size:[])));
          },
          child: Column(
            children: <Widget>[
              Stack(

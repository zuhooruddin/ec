...
import 'package:devkitflutter/model/shopping_cart_model.dart';
...
import 'package:devkitflutter/ui/shopping_cart/delivery.dart';
          ...
          child: Container(
            child: Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailPage(name: shoppingCartData[index].name, image: shoppingCartData[index].image, price: shoppingCartData[index].price, rating: 4, review: 23, sale: 36,color:[],size:[])));
                  },
                  child: ClipRRect(
                      borderRadius:

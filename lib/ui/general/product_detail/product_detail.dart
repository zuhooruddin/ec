...
import 'package:devkitflutter/APi/FeaturedApi.dart';
...
import 'package:devkitflutter/model/related_product_model.dart';
import 'package:devkitflutter/model/review_model.dart';
import 'package:devkitflutter/ui/general/chat_us.dart';
import 'package:devkitflutter/ui/general/notification.dart';
import 'package:devkitflutter/ui/general/product_detail/delivery_estimated.dart';
import 'package:devkitflutter/ui/general/product_detail/product_description.dart';
import 'package:devkitflutter/ui/general/product_detail/product_review.dart';
...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage({Key? key, this.name='', this.image='', this.price=24, this.rating=4, this.review=45, this.sale=63, required this.color, required this.size,this.slug=''}) : super(key: key);
...
List<Featured> myrelated=[];
 ...
 FeaturedApi featureapi=new FeaturedApi();
  ...
  Future<void> fetchallrelateditem() async {
    final related=await featureapi.fetchrelated(widget.slug);
    setState(() {
...
fetchallrelateditem();
    _imgProductSlider.add(GLOBAL_URL+'media/'+ widget.image);
    _imgProductSlider.add(GLOBAL_URL+'media/'+ widget.image);
    _imgProductSlider.add(GLOBAL_URL+'media/'+ widget.image);
    _imgProductSlider.add(GLOBAL_URL+'media/'+ widget.image);
    _imgProductSlider.add(GLOBAL_URL+'media/'+ widget.image);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('\BHD: '+_globalFunction.removeDecimalZeroFormat(widget.price), style: GlobalStyle.detailProductPrice),
              GestureDetector(
                onTap: (){
                  setState(() {
                    if(_isLove==true){
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(widget.size[_sizeIndex], style: TextStyle(
            ...
            Wrap(
              children: List.generate(widget.size.length,(index){
                return radioSize(widget.size[index],index);
              }),
            ):  Wrap(
            ...
            Row(
              children: [
                ...
                widget.color.length!=0?
                Text(widget.color[_colorIndex], style: TextStyle(
                    fontWeight: FontWeight.bold
            ...
            Wrap(
              children: List.generate(widget.color.length,(index){
                return radioColor(widget.color[index],index);
              }),
            ):  Wrap(
                  ...
                  return Container(
                    ...
                    child: Card(
                      ...
                      child: GestureDetector(
                        behavior: HitTestBehavior.translucent,
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailPage(name: relatedProductData[index].name, image: relatedProductData[index].image, price: relatedProductData[index].price, rating: relatedProductData[index].rating, review: relatedProductData[index].review, sale: 36,color:[],size:[],slug:widget.slug.toString())));
                        },
                        child: Column(
                          children: <Widget>[
                            ClipRRect(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text('\BHD : '+_globalFunction.removeDecimalZeroFormat(relatedProductData[index].price), style: GlobalStyle.productPrice),
                                  ),
                                  Container(
                                    margin: EdgeInsets.only(top:5),
                                    child: Row(

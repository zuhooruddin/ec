...
class RecomendedProductModel {
  ...
  RecomendedProductModel({required this.id, required this.name, required this.price, required this.image, required this.rating, required this.review, required this.sale, required this.location});
}
...
List<RecomendedProductModel> recomendedProductData =[
  ...
  RecomendedProductModel(
      id: 19,
      name: 'Xiaomi Yi Dash Camera Nightscape 1080P 60FPS ADAS Night Vision Dashcam',
      price: 46.6,

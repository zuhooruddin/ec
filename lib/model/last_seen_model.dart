...
class LastSeenModel {
  ...
  LastSeenModel({required this.id, required this.name, required this.price, required this.image, required this.rating, required this.review, required this.sale, required this.location});
}
...
List<LastSeenModel> lastSeenData =[
  ...
  LastSeenModel(
      id: 11,
      name: 'iPhone XS Max / XS / X / XR Case Spigen Clear Anti Shock Ultra Hybrid - Matte Black, XS Max',
      price: 16.6,
  ...
  LastSeenModel(
      id: 17,
      name: 'Samyang Noodle Wholesaler 1 Box (40 Pcs) Hot Spicy Chicken - Original Jan 21',
      price: 26,

...
class RelatedProductModel {
  ...
  RelatedProductModel({required this.id, required this.name, required this.price, required this.image, required this.rating, required this.review});
}

List<RelatedProductModel> relatedProductData =[
  RelatedProductModel(
      id: 1,
      name: 'Converter APPLE USB-C To 3.5 mm Headphone Jack Adapter New Ipad Pro',
      price: 10,
  ...
  RelatedProductModel(
      id: 2,
      name: 'Charger adapter New Macbook Pro Retina 13 inch Apple 2017 2018 61w ori',
      price: 46,
  ...
  RelatedProductModel(
      id: 7,
      name: 'Mac Mini 3.0GHz 6-Core Processor with Turbo Boost up to 4.1GHz 512GB Storage',
      price: 1099,

...
class SearchProductModel {
  ...
  SearchProductModel({required this.id, required this.name, required this.price, required this.image, required this.rating, required this.review, required this.sale, required this.location});
}
...
List<SearchProductModel> searchProductData =[
  ...
  SearchProductModel(
      id: 17,
      name: 'KABEL DATA TYPE-C TO TYPE-C BASEUS HALO DATA CABLE PD 2.0 60W - 0.5 M',
      price: 3,
